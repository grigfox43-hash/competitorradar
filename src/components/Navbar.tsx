...
export function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-40 backdrop-blur-md bg-radar-bg/85 border-b border-radar-border">
            ...
            <div className="pt-2 flex flex-col gap-2">
              {user ? (
                ...
                <>
                  <button
                    onClick={() => openAuth('login')}
                    className="w-full text-center text-sm font-medium text-radar-text py-2 rounded-lg border border-radar-border bg-[#161C28]"
                  >
                    {t('nav.login')}
                  </button>
                  <button
                    onClick={() => openAuth('signup')}
                    className="w-full text-center text-sm font-semibold text-black bg-radar-accent py-2.5 rounded-lg"
                  >
                    {t('nav.startFree')}
                  </button>
                </>
